...
namespace AdventOfCode
{
    public class Round
    {
        ...
        public Round(string opp, string choice)
        {
            Opponnent = opp;
            Choice = choice;
    ...
    internal class RockPaperScissors
    {
        static void Main(string[] args)
        {
            ...
            foreach (Round p in predictions)
            {
                if ((p.Opponnent == "A" && p.Choice == "Y") || (p.Opponnent == "B" && p.Choice == "Z") || (p.Opponnent == "C" && p.Choice == "X"))
                {
                    score += 6;
                }
                else if ((p.Opponnent == "A" && p.Choice == "X") || (p.Opponnent == "B" && p.Choice == "Y") || (p.Opponnent == "C" && p.Choice == "Z"))
                {
                    score += 3;
                }
                switch (p.Choice)
