    ...
    internal class CalorieCounting
    {
        static void Main(string[] args)
        {
             ...
             * --- Day 1: Calorie Counting ---
               ...
               In case the Elves get hungry and need extra snacks, they need to know which Elf to ask: they'd like to know how many Calories are being carried by theElfcarryingthe         most            Calories. In the example above, this is 24000 (carried by the fourth Elf).
